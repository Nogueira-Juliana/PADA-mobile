...
export const TitleMainCode = styled.Text`
  position: absolute;
  top: 10px;
  font-style: normal;
  font-weight: 500;
...
export const ContainerInformationCode = styled.View`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
export const TitleInformationCode = styled.Text`
  font-style: normal;
  font-weight: 700;
  font-size: 22px;
  text-align: center;
...
export const SubTitleInformationCode = styled.Text`
  width: 250px;
  height: 70px;
  margin-top: 20px;
  font-style: normal;
