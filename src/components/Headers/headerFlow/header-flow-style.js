...
export const ContainerHeaderFlow = styled.View`
  display: flex;
...
export const ContainerBackFlow = styled.TouchableOpacity`
  position: absolute;
  width: 25px;
  height: 25px;
  right: 15px;
...
export const TitleHeaderFlow = styled.Text`
  font-style: normal;
  font-weight: 700;
  font-size: 20px;
  line-height: 29px;
...
export const SubTitleHeaderFlow = styled.Text`
  font-style: normal;
  font-weight: 500;
  font-size: 10px;
  line-height: 14px;
...
export const ContainerButtonsHeaderFlow = styled.View`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
